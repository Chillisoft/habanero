...
--
-- Create schema habanero_test_branch_2_3_2
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ habanero_test_branch_2_3_2;
USE habanero_test_branch_2_3_2;

--
-- Table structure for table `habanero_test_branch_2_3_2`.`another_number_generator`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`another_number_generator`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`bowithintid`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`bowithintid`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`car_table`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`car_table`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`circle_concrete`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`circle_concrete`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`circle_table`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`circle_table`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`contact_person`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`contact_person`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`contact_person_address`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`contact_person_address`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`contactpersoncompositekey`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`contactpersoncompositekey`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`database_lookup_guid`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`database_lookup_guid`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`database_lookup_int`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`database_lookup_int`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`filledcircle_concrete`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`filledcircle_concrete`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`filledcircle_table`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`filledcircle_table`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`mockbo`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`mockbo`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`mybo`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`mybo`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`numbergenerator`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`numbergenerator`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`organisation`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`organisation`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`shape_table`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`shape_table`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`stubdatabasetransaction`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`stubdatabasetransaction`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_class_car`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_class_car`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_class_engine`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_class_engine`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_class_legalentity`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_class_legalentity`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_class_organisation`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_class_organisation`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_class_part`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_class_part`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_class_person`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_class_person`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_class_vehicle`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_class_vehicle`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_engine`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_engine`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_entity`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_entity`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`table_organisationperson`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`table_organisationperson`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`testautoinc`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`testautoinc`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`testtableread`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`testtableread`
--
...
--
-- Table structure for table `habanero_test_branch_2_3_2`.`transactionlog`
--
...
--
-- Dumping data for table `habanero_test_branch_2_3_2`.`transactionlog`
--
