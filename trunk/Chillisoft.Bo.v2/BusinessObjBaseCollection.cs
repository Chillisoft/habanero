...
namespace Chillisoft.Bo.v2
{
    ...
    public class BusinessObjectBaseCollection : ICollection
    {
        ...
        public BusinessObjectBaseCollection(BusinessObjectBase bo) : this(bo.ClassDef)
        {
        }
        ...
        public void FireBusinessObjectAdded(BusinessObjectBase bo)
        {
            if (this.BusinessObjectAdded != null)
            {
                this.BusinessObjectAdded(this, new BusinessObjectEventArgs(bo));
            }
        }
        ...
        public void FireBusinessObjectRemoved(BusinessObjectBase bo)
        {
            if (this.BusinessObjectRemoved != null)
            {
                this.BusinessObjectRemoved(this, new BusinessObjectEventArgs(bo));
            }
        }
        ...
        private void BusinessObjectDeletedHandler(object sender, BusinessObjectEventArgs e)
        {
        ...
        public void Add(BusinessObjectBaseCollection col)
        {
        ...
        //public void Add(Collection<BusinessObjectBaseCollection> col)
        //{
        //    foreach (BusinessObjectBaseCollection collection in col)
        //    {
        //        this.Add(collection);
        //    }
        //}
...
//			return null;
        ...
        /// found</returns>
        public BusinessObjectBase FindByGuid(Guid searchTerm)
        {
...
//            formattedSearchItem.Insert(0, _boClassDef.PrimaryKeyDef.KeyName + "=");
        ...
        public BusinessObjectBaseCollection Intersection(BusinessObjectBaseCollection col2)
        {
            BusinessObjectBaseCollection intersectionCol = new BusinessObjectBaseCollection(this.ClassDef);
            foreach (BusinessObjectBase businessObjectBase in this)
            {
        ...
        public BusinessObjectBaseCollection Union(BusinessObjectBaseCollection col2)
        {
            BusinessObjectBaseCollection unionCol = new BusinessObjectBaseCollection(this.ClassDef);
            foreach (BusinessObjectBase businessObjectBase in this)
            {
                unionCol.Add(businessObjectBase);
            }
            foreach (BusinessObjectBase businessObjectBase in col2)
            {
        ...
        public BusinessObjectBaseCollection Clone()
        {
            BusinessObjectBaseCollection clonedCol = new BusinessObjectBaseCollection(this.ClassDef);
            foreach (BusinessObjectBase businessObjectBase in this)
            {
        ...
        public BusinessObjectBaseCollection GetSortedCol(string propertyName, bool isAscending)
        {
            //test
            BusinessObjectBaseCollection sortedCol = new BusinessObjectBaseCollection(this.ClassDef);
            foreach (BusinessObjectBase bo in GetSortedList(propertyName, isAscending))
            {
                sortedCol.Add(bo);
            }
            return sortedCol;
