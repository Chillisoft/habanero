...
namespace Chillisoft.Bo.v2
{
    ...
    public delegate void BusinessObjectUpdatedHandler(Object sender, BusinessObjectEventArgs e);

    /// <summary>
    /// Provides a super-class for business objects. This class contains all
    /// the common functionality used by business objects.
    /// </summary>
    public abstract class BusinessObjectBase : ITransaction, Synchronisable, BusinessObject
    {
        private static readonly ILog log = LogManager.GetLogger("Chillisoft.Bo.v2.BusinessObjectBase");
        ...
        /// </summary>
        protected internal BusinessObjectBase() : this(DatabaseConnection.CurrentConnection)
        {
        }
        ...
        protected internal BusinessObjectBase(IDatabaseConnection conn) : this((ClassDef) null, conn)
        {
        }
        ...
        protected internal BusinessObjectBase(ClassDef def) : this(def, DatabaseConnection.CurrentConnection)
        {
        }
        ...
        /// <param name="def">The class definition</param>
        /// <param name="conn">A database connection</param>
        protected internal BusinessObjectBase(ClassDef def, IDatabaseConnection conn)
        {
            SetIsDeleted(false);
            SetIsDirty(false);
            SetIsEditing(false);
        ...
        protected BusinessObjectBase(BOPrimaryKey id) : this(id, DatabaseConnection.CurrentConnection)
        {
        }
        ...
        /// <param name="id">The primary key ID</param>
        /// <param name="conn">A database connection</param>
        protected BusinessObjectBase(BOPrimaryKey id, IDatabaseConnection conn)
        {
        ...
        protected BusinessObjectBase(IExpression searchExpression)
        ...
        /// data reader</returns>
        [ReflectionPermission(SecurityAction.Demand)]
        protected internal BusinessObjectBase GetBusinessObject(IDataRecord dr)
        {
        ...
        protected static BusinessObjectBase GetLoadedBusinessObject(BOPrimaryKey id)
        {
        ...
        /// <param name="id">The ID</param>
        /// <returns>Returns a business object</returns>
        protected static BusinessObjectBase GetLoadedBusinessObject(string id)
        {
        ...
        protected static BusinessObjectBase GetLoadedBusinessObject(string id, bool refreshIfReqNotCurrent)
        {
            ...
            {
                BusinessObjectBase lBusinessObjectBase;
                ...
                {
                    lBusinessObjectBase = (BusinessObjectBase) weakRef.Target;
                    //Apply concurrency Control Strategy to the Business Object
                    if (refreshIfReqNotCurrent)
                    {
                        lBusinessObjectBase.CheckConcurrencyOnGettingObjectFromObjectManager();
                    }
                    return lBusinessObjectBase;
                }
                else
                {
        ...
        /// </summary>
        /// <returns>Returns a business object</returns>
        protected internal BusinessObjectBase GetLoadedBusinessObject()
        {
            BusinessObjectBase busObj = GetLoadedBusinessObject(ID);
            if (busObj == null)
            {
        ...
        protected internal BusinessObjectBase GetLoadedBusinessObject(IDataReader dr)
        {
            BusinessObjectBase busObj = GetLoadedBusinessObject(ID);
            if (busObj == null)
            {
        ...
        /// runs
        /// </summary>
        /// <param name="myBusinessObjectBase">The business object</param>
        /// TODO ERIC - "will be cleaned" or "will not"?
        protected static void AddToLoadedBusinessObjectCol(BusinessObjectBase myBusinessObjectBase)
        {
            GetLoadedBusinessObjectBaseCol().Add(myBusinessObjectBase.ID.GetObjectId(),
                                                 new WeakReference(myBusinessObjectBase));
        }
...
//					                                     DatabaseConnection.CurrentConnection.RightDateDelimiter)) ;);
        ...
        private void FireUpdatedEvent()
        {
            ...
            {
                this.Updated(this, new BusinessObjectEventArgs(this));
            }
        }
        ...
        private void FireDeleted()
        {
            ...
            {
                this.Deleted(this, new BusinessObjectEventArgs(this));
            }
        }
