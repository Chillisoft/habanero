...
namespace Habanero.Test.Bo
{
    ...
    public class TestPropRuleInt
    {
        ...
        public void TestIntRule()
        {
            ...
            Assert.IsTrue(errorMessage.Length == 0);
            errorMessage = "";
            Assert.IsFalse(rule.isPropValueValid(-5, ref errorMessage));
            Assert.IsTrue(errorMessage.Length > 0);
        }
    }
}
