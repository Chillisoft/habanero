...
//            Assert.AreEqual("", dbConn.GetLimitClauseForEnd(1));
        ...
        {
            //---------------Set up test pack-------------------
            DatabaseConfig databaseConfig = new DatabaseConfig("SqlServer", "localhost", "habanero_test_tag_2_3_0", "sa", "sa", null);
            DatabaseConnection.CurrentConnection = databaseConfig.GetDatabaseConnection();
            //DatabaseConnection.CurrentConnection = new DatabaseConnectionSqlServer("System.Data", "System.Data.SqlClient.SqlConnection","server=localhost;database=habanero_test_tag_2_3_0;user=sa;password=sa");
