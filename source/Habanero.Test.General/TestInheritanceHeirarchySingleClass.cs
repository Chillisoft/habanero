...
namespace Habanero.Test.General
{
    ...
    public class TestInheritanceHeirarchySingleClass : TestInheritanceHeirarchyBase
    {
        ...
        //    Assert.AreEqual("UPDATE Shape SET ShapeID = ?Param0, ShapeName = ?Param1, Radius = ?Param2 WHERE ShapeID = ?Param3",
        //                    itsUpdateSql[0].Statement.ToString(),
        //                    "Update sql statement is incorrect.");
        //    Assert.AreEqual("MyFilledCircle", ((IDbDataParameter) itsUpdateSql[0].Parameters[1]).Value,
        ...
        //    Assert.AreEqual(5, ((IDbDataParameter)itsUpdateSql[0].Parameters[2]).Value,
