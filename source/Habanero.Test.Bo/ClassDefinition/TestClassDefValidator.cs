    ...
    public class TestClassDefValidator
    {
       ...
       [Test]
        ...
        public void TestLoadClassDefs_KeyDefinedWithInheritedProperties()
        {
            ...
            Assert.AreNotSame(propDef, keyDefPropDef, "The key's property should have been resolved to be the property of the superclass by the loader.");
            //-------------Execute test ---------------------
            validator.ValidateClassDefs(classDefList);
            //-------------Test Result ----------------------
            IPropDef keyDefPropDefAfterValidate = keyDef["TestClassName"];
