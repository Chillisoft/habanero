...
namespace Habanero.UI.Base
{
    public interface IDataGridView
    {
        ...
        /// <exception cref="T:System.Exception">Initialization of the editing cell value failed and either there is no handler for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.DataError"></see> event or the handler has set the <see cref="P:Gizmox.WebGUI.Forms.DataGridViewDataErrorEventArgs.ThrowException"></see> property to true. The exception object can typically be cast to type <see cref="T:System.FormatException"></see>.</exception>
        /// <exception cref="T:System.InvalidCastException">The type indicated by the cell's <see cref="P:Gizmox.WebGUI.Forms.DataGridViewCell.EditType"></see> property does not derive from the <see cref="T:Gizmox.WebGUI.Forms.Control"></see> type.-or-The type indicated by the cell's <see cref="P:Gizmox.WebGUI.Forms.DataGridViewCell.EditType"></see> property does not implement the <see cref="T:Gizmox.WebGUI.Forms.IDataGridViewEditingControl"></see> interface.</exception>
        /// <exception cref="T:System.InvalidOperationException"><see cref="P:Gizmox.WebGUI.Forms.DataGridView.CurrentCell"></see> is not set to a valid cell.-or-This method was called in a handler for the <see cref="E:Gizmox.WebGUI.Forms.DataGridView.CellBeginEdit"></see> event.</exception>
        ...
        /// <returns>true if successful; false if a <see cref="DataError"></see> event occurred.</returns>
        /// <filterpriority>1</filterpriority>
        bool RefreshEdit();
        ...
        /// <summary>Sorts the contents of the <see cref="IDataGridView"></see> control using an implementation of the <see cref="T:System.Collections.IComparer"></see> interface.</summary>
        ...
        /// <exception cref="T:System.InvalidOperationException"><see cref="VirtualMode"></see> is set to true.-or- <see cref="P:Gizmox.WebGUI.Forms.DataGridView.DataSource"></see> is not null.</exception>
        /// <exception cref="T:System.ArgumentNullException">comparer is null.</exception>
        /// <filterpriority>1</filterpriority>
        void Sort(IComparer comparer);

        /// <summary>Sorts the contents of the <see cref="IDataGridView"></see> control in ascending or descending order based on the contents of the specified column.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether the user is allowed to delete rows from the <see cref="IDataGridView"></see>.</summary>
        ...
        /// <returns>The <see cref="IDataGridViewColumnCollection"></see> that contains all the columns in the <see cref="IDataGridView"></see> control.</returns>
        /// <filterpriority>1</filterpriority>
        [Editor(
        ...
        /// <returns>The <see cref="IDataGridViewCell"></see> that represents the current cell, or null if there is no current cell. The default is the first cell in the first column or null if there are no cells in the control.</returns>
        /// <exception cref="T:System.ArgumentException">The specified cell when setting this property is not in the <see cref="IDataGridView"></see>.</exception>
        ...
        /// <returns>The <see cref="IDataGridViewRow"></see> that represents the row containing the current cell, or null if there is no current cell.</returns>
        [Browsable(false)]
        IDataGridViewRow CurrentRow { get; }

        /// <summary>Gets or sets the name of the list or table in the data source for which the <see cref="IDataGridView"></see> is displaying data.</summary>
        /// <returns>The name of the table or list in the <see cref="DataSource"></see> for which the <see cref="IDataGridView"></see> is displaying data. The default is <see cref="F:System.String.Empty"></see>.</returns>
        ...
        /// <exception cref="T:System.Exception">An error occurred in the data source and either there is no handler for the </see> event or the handler has set the </see> property to true. The exception object can typically be cast to type <see cref="T:System.FormatException"></see>.</exception>
        /// <filterpriority>1</filterpriority>
        ...
        /// <summary>Gets or sets a value indicating whether the user is allowed to select more than one cell, row, or column of the <see cref="IDataGridView"></see> at a time.</summary>
        ...
        /// <returns>true if the user cannot edit the cells of the <see cref="IDataGridView"></see> control; otherwise, false. The default is false.</returns>
        ...
        /// <exception cref="T:System.ArgumentException">The specified value when setting this property is less than 0.-or-The specified value is less than 1 and <see cref="AllowUserToAddRows"></see> is set to true. </exception>
        ...
        /// <exception cref="T:System.InvalidOperationException">The specified value when setting this property is false and the </see> property is set to </see> or </see>.</exception>
        /// <filterpriority>1</filterpriority>
        [ DefaultValue(true)]
        ...
        /// <returns>A <see cref="IDataGridViewRowCollection"></see> that contains all the rows in the <see cref="IDataGridView"></see>.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        ...
        /// <returns>The <see cref="IDataGridViewColumn"></see> by which the <see cref="IDataGridView"></see> contents are currently sorted.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        IDataGridViewColumn SortedColumn { get; }

        ///// <summary>Gets a value indicating whether the items in the <see cref="IDataGridView"></see> control are sorted in ascending or descending order, or are not sorted.</summary>
