    ...
    public class Sample : BusinessObject
    {
        ...
        public abstract class SampleUserInterfaceMapper: ISampleUserInterfaceMapper
        {
            ...
            public UIForm SampleUserInterfaceMapper3Props()
            {
                ...
                UIFormTab tab = new UIFormTab();
                UIFormColumn col = new UIFormColumn(100);
                col.Add(new UIFormField("Text:", "SampleText", _textBoxTypeName, _textBoxAssemblyName, "TextBoxMapper", "", true, null, null, new Hashtable(), LayoutStyle.Label));
                col.Add(
            ...
            public UIForm SampleUserInterfaceMapperPrivatePropOnly()
            {
                ...
                UIFormColumn col = new UIFormColumn(100);
                tab.Add(col);
                col.Add(new UIFormField("Private Text:", "SampleTextPrivate", _textBoxTypeName, _textBoxAssemblyName, "TextBoxMapper", "", true, null, null, new Hashtable(), LayoutStyle.Label));
                return def;
            }
