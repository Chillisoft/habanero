...
namespace Habanero.DB
{
    ...
    /// Access database
    /// </summary>
    public class ConnectionStringAccess2007Factory : ConnectionStringFactory
    {
        /// <summary>
        ...
        {
            return
                String.Format("Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};User ID={1};password={2}", database,
                              userName, password);
        }
    }
}