...
//        }
		...
		private void UpdateIsEditable()
		{
			...
			if (_isEditable)
			{
                ...
                if (_control is CheckBox) _control.BackColor = SystemColors.Control;
        ...
        protected internal abstract void ApplyChangesToBusinessObject();
        ...
        {
            if (mapperTypeName == "TextBoxMapper" && !(ctl is TextBox)) // TODO && !(ctl is PasswordTextBox))
            {
