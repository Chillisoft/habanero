...
namespace Habanero.Test.BO
{
    ...
    public class TestBOHelper
    {
        ...
        {
            //---------------Set up test pack-------------------
            IBusinessObjectRule rule1 = Substitute.For<IBusinessObjectRule>();
            IBusinessObjectRule rule2 = Substitute.For<IBusinessObjectRule>();
            IBusinessObjectRule rule3 = Substitute.For<IBusinessObjectRule>();
            IBusinessObjectRule rule4 = Substitute.For<IBusinessObjectRule>();
