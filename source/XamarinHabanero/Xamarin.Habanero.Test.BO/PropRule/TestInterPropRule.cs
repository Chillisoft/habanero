...
namespace Habanero.Test.BO.PropRule
{
    ...
    public class TestInterPropRule
    {
        ...
        {
            IBusinessObject bo = Substitute.For<IBusinessObject>();
            bo.GetPropertyValue(prop1.PropertyName).Returns(prop1Value);
            bo.GetPropertyValue(prop2.PropertyName).Returns(prop2Value);
            return bo;
        }
        /// <summary>
