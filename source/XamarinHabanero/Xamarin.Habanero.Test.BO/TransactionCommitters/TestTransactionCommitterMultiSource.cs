...
namespace Habanero.Test.BO.TransactionCommitters
{
    ...
    public class TestTransactionCommitterMultiSource
    {
        ...
        {
            //---------------Set up test pack-------------------
            IDataAccessor defaultDataAccessor = Substitute.For<IDataAccessor>();
            IDataAccessor alternateDataAccessor = Substitute.For<IDataAccessor>();
            ...
            //---------------Assert Precondition----------------
            defaultDataAccessor.DidNotReceive().CreateTransactionCommitter();
            alternateDataAccessor.DidNotReceive().CreateTransactionCommitter();
