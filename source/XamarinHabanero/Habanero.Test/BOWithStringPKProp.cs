...
namespace Habanero.Test
{
    ...
    public class BOWithIntPKProp : BusinessObject
    {
        private const string PK1_PROP1_NAME = "PK1Prop1";



        public Int32? PK1Prop1
        {
            get { return (Int32?)GetPropertyValue(PK1_PROP1_NAME); }
            set { SetPropertyValue(PK1_PROP1_NAME, value); }
        }
        ...
        protected static PropDefCol CreateBOPropDef()
        {
            ...
            var propDef = new PropDef(PK1_PROP1_NAME, typeof(Int32?), PropReadWriteRule.ReadWrite, "PK1_Prop1", null);
            lPropDefCol.Add(propDef);
