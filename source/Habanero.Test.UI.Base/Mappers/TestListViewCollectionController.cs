...
namespace Habanero.Test.UI.Base
{
    ...
    public abstract class TestListViewCollectionController:TestUsingDatabase
    {
        ...
        //IListView _listView;
        //ListViewCollectionController controller;
        ...
        public void TestCreateListViewCollectionController()
        {
            ...
            //---------------Execute Test ----------------------
            ListViewCollectionController cntrl = new ListViewCollectionController(listView, classDef);
            //---------------Test Result -----------------------
        ...
        {
            //---------------Set up test pack-------------------
            ListViewCollectionController cntrl = CreateDefaultListVievController();
        ...
        private UIDef GetDefaultUIDef(ListViewCollectionController cntrl)
        {
            return cntrl.ClassDef.UIDefCol["default"];
        }

        private ListViewCollectionController CreateDefaultListVievController()
        {
            ClassDef classDef = MyBO.LoadDefaultClassDef();
            IListView listView = GetControlFactory().CreateListView();
            ListViewCollectionController cntrl = new ListViewCollectionController(listView, classDef);
        ...
        //    //---------------Set up test pack-------------------
        //    IListView listView = GetControlFactory().CreateListView();
        //    ListViewCollectionController controller = new ListViewCollectionController(listView);
