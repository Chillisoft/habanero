...
namespace Habanero.Test.UI.Base.FilterController
{
        public abstract class TestFilterControl
        {
                ...
                public void MultipleFilters()
                {
                        ...
                        IFilterClause clause =
                                filterClauseFactory.CreateStringFilterClause("TestColumn", FilterClauseOperator.OpLike,
                                                                             "testvalue");
                        ...
                        IFilterClause clause2 =
                                filterClauseFactory.CreateStringFilterClause("TestColumn2", FilterClauseOperator.OpLike,
                                                                             "testvalue2");

                        IFilterClause compositeClause =
                                filterClauseFactory.CreateCompositeFilterClause(clause,
                                                                                FilterClauseCompositeOperator.OpAnd,
                                                                                clause2);
                ...
                public void TestAdd_DateRangeFilterComboBoxInclusive()
                {
                        ...
                        IFilterClause clause1 =
                                filterClauseFactory.CreateDateFilterClause("test",
                                                                           FilterClauseOperator.OpGreaterThanOrEqualTo,
                        ...
                        IFilterClause compClause =
                                filterClauseFactory.CreateCompositeFilterClause(clause1,
                                                                                FilterClauseCompositeOperator.OpAnd,
                                                                                clause2);
                        //---------------Test Result -----------------------

                        Assert.AreEqual(compClause.GetFilterClauseString(),
                ...
                public void TestAddStringFilterTextBox()
                {
                        ...
                        tb.Text = "";
                        //---------------Test Result -----------------------
                        Assert.AreEqual(nullClause.GetFilterClauseString(),
                                        filterControl.GetFilterClause().GetFilterClauseString());
                ...
                public void TestAdd_TwoStringFilterTextBox_Combo_GetControl()
                {
                        //---------------Set up test pack-------------------
                        IFilterControl filterControl = GetControlFactory().CreateFilterControl();
                        IComboBox tbExpected = filterControl.AddStringFilterComboBox("Test:", "TestColumn",
                                                                                     new string[] {""}, false);
                        filterControl.AddStringFilterTextBox("Test2:", "TestColumn2");
                        //---------------Execute Test ----------------------
                ...
                public void TestGetTextBoxFilterClause()
                {
                        ...
                        //---------------Test Result -----------------------
                        IFilterClause clause =
                                itsFilterClauseFactory.CreateStringFilterClause("TestColumn",
                                                                                FilterClauseOperator.OpLike, "testvalue");
                ...
                public void TestTwoStringTextBoxFilter()
                {
                        ...
                        IFilterClause clause1 =
                                itsFilterClauseFactory.CreateStringFilterClause("TestColumn",
                                                                                FilterClauseOperator.OpLike, "testvalue");
                        IFilterClause clause2 =
                                itsFilterClauseFactory.CreateStringFilterClause("TestColumn2",
                                                                                FilterClauseOperator.OpLike,
                                                                                "testvalue2");
                        IFilterClause fullClause =
                                itsFilterClauseFactory.CreateCompositeFilterClause(clause1,
                                                                                   FilterClauseCompositeOperator.OpAnd,
                                                                                   clause2);
                ...
                public void TestGetComboBoxAddSelectedItems()
                {
                        ...
                        int numItemsExpectedInComboBox = numOfItemsInCollection + 1;
                                //one extra for the null selected item
                ...
                public void TestGetComboBoxFilterClause()
                {
                        ...
                        //---------------Test Result -----------------------
                        IFilterClause clause =
                                filterClauseFactory.CreateStringFilterClause("TestColumn", FilterClauseOperator.OpEquals,
                                                                             "1");
                        Assert.AreEqual(clause.GetFilterClauseString(), filterClauseString);
                ...
                public class TestFilterControlWin : TestFilterControl
                {
                        ...
                        public void TestChangeCheckBoxAppliesFilter()
                        {
                                ...
                                //---------------Test Result -----------------------
                                Assert.IsTrue(filterFired,
                                              "The filter event should have been fired when the text was changed.");
                        }
                        ...
                        public void TestChangeCheckBoxDoesNotApplyFilter_InSearchMode()
                        {
                                ...
                                //---------------Test Result -----------------------
                                Assert.IsFalse(filterFired,
                                               "The filter event should not have been fired when the text was changed.");
                        }
                        ...
                        public void TestComboBoxTextChangedEventAppliesFilter()
                        {
                                ...
                                IComboBox comboBox = ctl.AddStringFilterComboBox("test", "propname", optionList, true,true);
                        ...
                        [Test]
                        public void TestDefaultComboBoxTextChangedEventDoesNotApplyFilter()
                        {
                                //---------------Set up test pack-------------------
                                IControlFactory factory = GetControlFactory();
                                IFilterControl ctl = factory.CreateFilterControl();
                        ...
                        public void TestChangeDateRangeComboBoxAppliesFilter()
                        {
                                ...
                                IControlFactory factory = GetControlFactory();
                                IFilterControl ctl = factory.CreateFilterControl();
                                IDateRangeComboBox dateRangeComboBox = ctl.AddDateRangeFilterComboBox("test", "propname",
                                                                                                      true, true);
                                string text = TestUtil.CreateRandomString();
                        ...
                        public void TestChangeDateTimePickerAppliesFilter()
                        {
                                ...
                                IControlFactory factory = GetControlFactory();
                                IFilterControl ctl = factory.CreateFilterControl();
                                IDateTimePicker dateTimePicker = ctl.AddDateFilterDateTimePicker("test", "propname",
                                                                                                 DateTime.Now,
        ...
        internal class CustomFilterStub : FilterControlManager.ICustomFilter
        {
                ...
                {
                        return filterClauseFactory.CreateStringFilterClause("test", FilterClauseOperator.OpEquals,
                                                                            _box.Text);
                }
                ...
                private void CustomFilterStub_ValueChanged(object sender, EventArgs e)
                {
