...
namespace Habanero.Test.UI.Base
{
    ...
    public abstract class TestFlowLayoutManager
    {
        ...
        {            
            //---------------Set up test pack-------------------
            IChilliControl  managedControl = GetControlFactory().CreateControl();
            //---------------Execute Test ----------------------
        ...
        {
            //---------------Set up test pack-------------------
            IChilliControl  managedControl = CreateManagedControl();
            FlowLayoutManager manager = CreateFlowLayoutManager(managedControl);
            //---------------Execute Test ----------------------
            IChilliControl  ctlToAdd = CreateStandardControl();
        ...
        private IChilliControl CreateStandardControl()
        {
        ...
        public void TestAddTwoControls()
        {
            ...
            IChilliControl ctl2 = CreateStandardControl();
        ...
        public void TestAddThreeControlsOfDifferentHeightWithWrap()
        {
            ...
            IChilliControl managedControl = CreateManagedControl();
            FlowLayoutManager manager = CreateFlowLayoutManager(managedControl);
            IChilliControl ctl2 = CreateControl(10, 20);
            //---------------Execute Test ----------------------
            managedControl.Width = 40;
            manager.AddControl(CreateStandardControl());
            manager.AddControl(ctl2);
            IChilliControl ctl = CreateStandardControl();
        ...
        public void TestResizeWhenNothingHappens()
        {
            ...
            FlowLayoutManager manager = CreateFlowLayoutManager(managedControl);
            //---------------Execute Test ----------------------
            IChilliControl ctl1 = CreateStandardControl();
            IChilliControl ctl2 = CreateStandardControl();
        ...
        public void TestRefreshOnGapSizeChange()
        {
            ...
            IChilliControl ctl = CreateControl(50, 20);
            manager.AddControl(ctl);
            manager.GapSize = 2;
            //---------------Test Result -----------------------
        ...
        public void TestCentreAlignRowTwoRows()
        {
            ...
            IChilliControl ctl = CreateControl(controlWidth, 10);
            IChilliControl ctl2 = CreateControl(controlWidth, 10);
            //---------------Execute Test ----------------------
            manager.Alignment = FlowLayoutManager.Alignments.Centre;
            manager.ManagedControl.Width = managedControlWidth;
            manager.AddControl(ctl);
        ...
        public void TestNewLine()
        {
            ...
            IChilliControl ctl = CreateControl(20, 10);
            IChilliControl ctl2 = CreateControl(20, 10);
            //---------------Execute Test ----------------------
            manager.AddControl(ctl);
            manager.NewLine();
            manager.AddControl(ctl2);
        ...
        public void TestGlueSimpleCase()
        {
            //---------------Set up test pack-------------------
            FlowLayoutManager manager = CreateFlowLayoutManager();
            IChilliControl ctl1 = CreateControl(35, 10);
            IChilliControl ctl2 = CreateControl(35, 10);
            //---------------Execute Test ----------------------
        ...
        public void TestGlueSimpleCase_DontAddSecondControlToGlue_Resize()
        {
            ...
            //---------------Execute Test ----------------------
            manager.AddControl(CreateControl(40, 10));
            IChilliControl gluedCtl = CreateControl(35, 10);
        ...
        public void TestGlueWithGluedControlAtLeftBorder()
        {
            ...
            FlowLayoutManager manager = CreateFlowLayoutManager();
            //---------------Execute Test ----------------------
            IChilliControl ctl = CreateControl(30, 10);
            manager.AddControl(ctl);
            manager.AddGlue();
            IChilliControl ctl2 = CreateControl(90, 10);
            manager.AddControl(ctl2);
        ...
        public void TestGlueWithGluedControlInvisible_ChangedToVisible()
        {
            ...
            FlowLayoutManager manager = CreateFlowLayoutManager();
            IChilliControl ctl = CreateControl(30, 10);
            IChilliControl ctl2 = CreateControl(50, 10);
            //---------------Execute Test ----------------------
        ...
        public void TestGlueWithGluedControlTooWideToKeepOnSameLine()
        {
            //---------------Set up test pack-------------------
            FlowLayoutManager manager = CreateFlowLayoutManager();
            IChilliControl ctl1 = CreateControl(30, 10);
            IChilliControl ctl2 = CreateControl(50, 10);
            IChilliControl ctl3 = CreateControl(50, 10);
            //---------------Execute Test ----------------------
            manager.AddControl(ctl1);
            manager.AddControl(ctl2);
            manager.AddGlue();
        ...
        public void TestRightAlignedTabOrdering()
        {
            ...
            //---------------Execute Test ----------------------
            manager.Alignment = FlowLayoutManager.Alignments.Right;
            IChilliControl ctl1 = CreateControl(20, 20);
            manager.AddControl(ctl1);
            IChilliControl ctl2 = CreateControl(20, 20);
            manager.AddControl(ctl2);
            //---------------Test Result -----------------------
        ...
        public void TestRightAlignedTabOrderingMultipleRows()
        {
            //---------------Set up test pack-------------------
            FlowLayoutManager manager = CreateFlowLayoutManager();
            IChilliControl ctl1 = CreateControl(50, 20);
            IChilliControl ctl2 = CreateControl(20, 20);
            IChilliControl ctl3 = CreateControl(50, 20);            
            //---------------Execute Test ----------------------
            manager.Alignment = FlowLayoutManager.Alignments.Right;
        ...
        public IChilliControl  CreateControl(int width, int height)
        {
        ...
        private static FlowLayoutManager CreateFlowLayoutManager(IChilliControl managedControl)
        {
            FlowLayoutManager manager = new FlowLayoutManager(managedControl);
        ...
        private IChilliControl CreateManagedControl()
        {
            IChilliControl managedControl = GetControlFactory().CreateControl();
