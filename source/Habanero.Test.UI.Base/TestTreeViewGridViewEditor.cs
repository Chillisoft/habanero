...
namespace Habanero.Test.UI.Forms
{
    ...
    /// </summary>
    public abstract class TestTreeViewGridViewEditor
    {
        private ITreeViewGridViewEditor itsTreeViewTableEditor;
        ...
        protected abstract ITreeViewGridViewEditor CreateEditorOnForm(out IFormChilli frm);
        protected abstract IControlFactory GetControlFactory();

        [TestFixture]
        public class TestTreeViewGridViewEditorWin : TestTreeViewGridViewEditor
        {
            protected override ITreeViewGridViewEditor CreateEditorOnForm(out IFormChilli frm)
            {
                frm = GetControlFactory().CreateForm();
                ITreeViewGridViewEditor editor = GetControlFactory().CreateTreeViewGridViewEditor();
        ...
        //[TestFixture]
        //public class TestTreeViewGridViewEditorGiz : TestTreeViewGridViewEditor
        //{
        //    protected override ITreeViewGridViewEditor CreateEditorOnForm(out IFormChilli frm)
        //    {
        ...
        public void TestLayoutOfEditor()
        {
            ...
            //---------------Execute Test ----------------------
            ITreeViewGridViewEditor editor = CreateEditorOnForm(out frm);
            //---------------Test Result -----------------------
