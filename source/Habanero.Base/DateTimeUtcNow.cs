...
namespace Habanero.Base
{
    ...
    ///</summary>
    [TypeConverter(typeof(DateTimeUtcNowConverter))]
    public class DateTimeUtcNow : IComparable<DateTime>, IComparable, IResolvableToValue, IResolvableToValue<DateTime>
    {
        ///<summary>
        ...
        {
            if (obj is DateTimeUtcNow) return 0;
