...
namespace Habanero.Test.DB
{
    ...
    public class TestDatabaseConnectionSqlServer
    {
        ...
        public void Test_NoColumnName_DoesntError_SqlServer()
        {
            ...
            DatabaseConfig databaseConfig = new DatabaseConfig("SqlServer", "localhost", "habanero_test_branch_2_5", "sa", "sa", null);
            DatabaseConnection.CurrentConnection = databaseConfig.GetDatabaseConnection();
            //DatabaseConnection.CurrentConnection = new DatabaseConnectionSqlServer("System.Data", "System.Data.SqlClient.SqlConnection","server=localhost;database=habanero_test_branch_2_5;user=sa;password=sa");
