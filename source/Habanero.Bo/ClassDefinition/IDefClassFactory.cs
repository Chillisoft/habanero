...
namespace Habanero.BO.ClassDefinition
{
	...
	public interface IDefClassFactory
	{
		...
		///<returns></returns>
		ISuperClassDef CreateSuperClassDef(string assemblyName, string className, ORMapping orMapping, string id, string discriminator);
		...
		///<returns></returns>
		IUIFormField CreateUIFormProperty(string label, string propertyName, string controlTypeName, string controlAssembly, string mapperTypeName, string mapperAssembly, bool editable, bool? showAsCompulsory, string toolTipText, Hashtable propertyAttributes, LayoutStyle layout);
		...
		///<returns></returns>
		IRelPropDef CreateRelPropDef(string propName, string relPropName);
