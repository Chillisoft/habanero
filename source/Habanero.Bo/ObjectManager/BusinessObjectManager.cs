        ...
        public virtual void Add(IBusinessObject businessObject)
        {
            ...
            lock (_lock)
            {
                ...
                if (loadedBusinessObject != null) 
                {
                    ...
                    string userMessage = "There was a serious developer exception. " + EnvironmentCF.NewLine
                                         + developerMessage;
        ...
        public virtual IBusinessObject this[Guid objectID]
        {
            get
            {
                ...
                throw new HabaneroDeveloperException
                    ("There is an application error please contact your system administrator." + EnvironmentCF.NewLine
                     + message, message);
            }
        }
                ...
                if (this.Contains(id))
                {
                    ...
                    } catch (HabaneroDeveloperException ex)
                    {
                        _log.Debug(
                            ...
                            ex.Message + EnvironmentCF.NewLine + ex.StackTrace);
                        return null;
                    }
                }
                return null;
