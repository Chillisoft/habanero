...
namespace Habanero.BO
{
    ...
    public class BusinessObjectManager
    {
        ...
        /// is loaded in the object manager it will be removed. When possible user <see cref="Remove(BusinessObject)"/>
        /// </summary>
        /// <param name="id">ID of the business object to be removed.</param>
        internal void Remove(BOPrimaryKey id)
        {
        ...
        /// <returns>The business object from the object manger.</returns>
        internal BusinessObject this[BOPrimaryKey objectID]
        {
